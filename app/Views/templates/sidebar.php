    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo site_url('mahasiswa') ?>" class="nav-link <?php echo $m_mahasiswa ?>">
        ...
        <div style="margin-top: 20px;">
					<a href="<?php echo base_url('login/logout') ?>" class="btn btn-block btn-primary btn-sm" style="color: #fff; width: 50%">Logout</a>
					<div>
      </nav>
      <!-- /.sidebar-menu -->
    </div>
